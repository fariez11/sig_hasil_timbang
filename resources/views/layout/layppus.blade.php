...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>SIPS - Petugas Puskesmas</title>
...
<body>
	...
	<div class="header">
		<div class="header-left">
			...
			<span class="micon dw dw-map-5" style="padding: 0px 10px 0px 30px;"></span> <span class="mtext">Kecamatan {{Session::get('kec')}}</span><span class="micon dw dw-hospital" style="padding: 0px 10px 0px 30px;"></span> <span class="mtext">Puskesmas {{Session::get('npus')}}</span>
		</div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    ?>
                    @foreach($ed as $upd)
                    <form action="/sespet:upd={{$upd->PENG_ID}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
